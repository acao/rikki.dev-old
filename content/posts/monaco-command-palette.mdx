...
Because of it's reliance on the LSP protocol, many of the default options are familiar.
...
You'll need to access the bitwise enum for [`monaco.KeyMod`](https://microsoft.github.io/monaco-editor/api/enums/monaco.keymod.html) and [`monaco.KeyCode`](https://microsoft.github.io/monaco-editor/api/enums/monaco.keycode.html)
